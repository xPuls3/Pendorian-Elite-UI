...
* A legacy looking sidebar.
* Remove the Pendoria logo.
* Make the dungeons tab a sidebar link.
* Move the areas tab into the battle tab.
* Remove the action tabs.
* Remove tradeskill selection dropdown.
...
## Notice
Given that Puls3 is a moderator, ~~a tester~~ (I was), and active on the development server, new features will most likely be made compatible before they even arrive on the live game.

If you have any issues using Violentmonkey's 'check for updates' feature and have been using the script since it was on Greasy Fork, then uninstall then reinstall directly from GitHub.
Considering how long ago this was I don't see this being an issue ever again.
...
If you have any issues using Violentmonkey's 'check for updates' feature and have been using the script since it was on Greasy Fork or have used a development release, then uninstall it, and reinstall directly from GitHub.
